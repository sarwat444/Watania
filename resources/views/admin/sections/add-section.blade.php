            ...
            <div id="addproduct-accordion" class="custom-accordion">
                <div class="card">
                        ...
                        <div class="p-4">
                            ...
                            <div class="media align-items-center">
                                ...
                                <div class="media-body overflow-hidden">
                                    <h5 class="font-size-16 mb-1">@lang('translation.section_info')</h5>
                    ...
                    <div id="addproduct-billinginfo-collapse" class="collapse show" data-parent="#addproduct-accordion">
                       ...
                       <div class="col-md-12">
                           <label for="example-text-input" >@lang('translation.section_name')  </label>
                            <input class="form-control" type="text"  id="example-text-input">
                                     ...
                                     <button type="submit" class="btn btn-primary mb-2 btn-submit">@lang('translation.add_section') </button>
