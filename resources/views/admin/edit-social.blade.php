...
@section('title')
@lang('translation.edit_sociallinks')
@endsection
@section('css')
...
@component('common-components.breadcrumb')
    ...
    @slot('title') @lang('translation.edit_sociallinks2')@endslot
@endcomponent
        ...
        <div class="col-lg-12">
            <div id="addproduct-accordion" class="custom-accordion">
                ...
                <div class="card">
                    <a href="#addproduct-img-collapse" class="text-dark collapsed" data-toggle="collapse" aria-expanded="false" aria-controls="addproduct-img-collapse">
                        <div class="p-4">
                            ...
                            <div class="media align-items-center">
                                ...
                                <div class="media-body overflow-hidden">
                                    <h5 class="font-size-16 mb-1"> @lang('translation.sociallinks_image2') </h5>
                   ...
                   <button type="submit" class="btn btn-primary mb-2 btn-submit">@lang('translation.edit_sociallinks2')</button>
