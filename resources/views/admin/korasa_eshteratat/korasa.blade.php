  ...
  <div class="row">
        ...
        @endif
                ...
                <div id="addproduct-accordion" class="custom-accordion">
                        <div class="card">
                            <form id="form" method="post" action="{{url('/admin/add_korasa')}}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                        ...
                                        <div class="p-4 border-top">
                                            <div class="card-body">
                                                ...
                                                <div class="col-md-12">
                                                                        ...
                                                                        <div data-repeater-list="inner-group" class="inner form-group">
                                                                            <div data-repeater-item class="inner mb-3 row">
                                                                                ...
                                                                                <div class="col-md-4 col-4">
                                                                                    <input type="number" class="inner form-control  inner-in2" name="values" placeholder="أضافه القيمه  الماليه "/>
                                                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-md-12">
                                                            <label  for="example-month-input" class="col-form-label">محتوى الكراسه </label>
                        ...
                        <div class="card">
                            ...
                            <div id="addproduct-img-collapse" class="collapse" data-parent="#addproduct-accordion">
                                <div class="p-4 border-top">
                                <label  for="example-month-input" class="col-form-label"> ملفات الكراسه </label>
                    ...
                    <button id="submit-form" onclick="submitForm()" type="submit" class="btn btn-primary mb-2 btn-submit">أظافه بيانات كراسه الاشتراطات </button>
