...
@component('common-components.breadcrumb')
    ...
    @slot('title') بيانات  أضافيه  @endslot
@endcomponent
        ...
        <div class="col-lg-12">
            ...
            @endif
                <div id="addproduct-accordion" class="custom-accordion">
                        <div class="card">
                            <form id="form" method="post" action="{{url('/admin/add_other/'.$projectDetails->id)}}" enctype="multipart/form-data">
											   {{ csrf_field() }}
													...
													<div class="p-4">
														...
														<div class="media align-items-center">
															...
															<div class="media-body overflow-hidden">
																<h5 class="font-size-16 mb-1">ملفات اضافيه    </h5>
															</div>
													...
													<div class="p-4 border-top">
														<div class="card-body">
																<div class="form-group row">
																	<div class="col-md-12">
																		<label  for="example-month-input" class="col-form-label">محتوى البيانات    </label>
                    ...
                    <button id="submit-form" onclick="submitForm()" type="submit" class="btn btn-primary mb-2 btn-submit">أظافه بيانات  البيانات   </button>
