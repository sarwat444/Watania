...
@section('content')
    @component('common-components.breadcrumb')
        ...
        @slot('title')تعديل بيانات العقد @endslot
    @endcomponent
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <form id="form" action="{{url('admin/edit_other/'.$akd_details->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="p-4">
                                ...
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body overflow-hidden">
                                        <h5 class="font-size-16 mb-1">بيانات العقد </h5>
                            ...
                            <div class="p-4 border-top">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <label for="example-month-input" class="col-form-label">محتوى العقد    </label>
                                            <textarea style="text-align: right" id="classic-editor" class="summernote form-control" name="content">{{$akd_details->content}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
										...
										<a href="#addproduct-img-collapse" class="text-dark collapsed" data-toggle="collapse" aria-expanded="false" aria-controls="addproduct-img-collapse">
											<div class="p-4">
												...
												<div class="media align-items-center">
													...
													<div class="media-body overflow-hidden">
														<h5 class="font-size-16 mb-1">ملفات العقود    </h5>
    ...
    {{-- end of row --}}
    <button onclick="submitForm()" class="btn btn-primary mb-2 btn-submit">تعديل  بيانات العقد   </button>
