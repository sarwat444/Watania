...
@component('common-components.breadcrumb')
    ...
    @slot('title') @lang('translation.edit_member')@endslot
@endcomponent
        ...
        <div class="col-lg-12">
            <div id="addproduct-accordion" class="custom-accordion">
                <div class="card">
                        ...
                        <div class="p-4">
                            ...
                            <div class="media align-items-center">
                                ...
                                <div class="media-body overflow-hidden">
                                    <h5 class="font-size-16 mb-1">@lang('translation.member_info')</h5>
                  ...
                  <div class="col-md-6">
                          <label for="example-datetime-local-input" >رقم الهاتف  </label>
                            <input class="form-control" type="text"  id="example-date-input">
                        </div>
                ...
                <div class="form-group  row">
                       <div class="col-md-6">
                           <label for="example-datetime-local-input" >المهنه   </label>
                            <input class="form-control" type="text"  id="example-date-input">
                        </div>
                  <div class="col-md-6">
                          <label for="example-datetime-local-input" >تاريخ الاضافه </label>
                ...
                <div class="form-group  row">
                       <div class="col-md-12">
                           <label for="example-datetime-local-input" >نبذه عن  العضو  </label>
             ...
             <div class="card">
                    <a href="#addproduct-img-collapse" class="text-dark collapsed" data-toggle="collapse" aria-expanded="false" aria-controls="addproduct-img-collapse">
                        <div class="p-4">
                            ...
                            <div class="media align-items-center">
                                ...
                                <div class="media-body overflow-hidden">
                                    <h5 class="font-size-16 mb-1"> @lang('translation.member_image') </h5>
                   ...
                   <button type="submit" class="btn btn-primary mb-2 btn-submit">@lang('translation.edit_member')</button>
