...
@section('content')
    @component('common-components.breadcrumb')
        ...
        @slot('title')تعديل بيانات الالتزام  @endslot
    @endcomponent
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <form id="form" action="{{url('admin/editeltezam/'.$eltezam_details->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="p-4">
                                ...
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body overflow-hidden">
                                        <h5 class="font-size-16 mb-1">بيانات الألتزام  </h5>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea style="text-align: right" id="classic-editor" class="summernote form-control" name="content">{{$eltezam_details->content}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    {{-- end of row --}}
    <button onclick="submitForm()" class="btn btn-primary mb-2 btn-submit">تعديل  بيانات الالتزام    </button>
