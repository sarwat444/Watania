...
@component('common-components.breadcrumb')
    ...
    @slot('title') @lang('translation.add_host')@endslot
@endcomponent
  ...
  <div class="row">
        <div class="col-lg-12">
            ...
            @endif
                <form id="create-form" method="post" enctype="multipart/form-data" action="{{url('admin/add-host')}}">
                    @csrf
                <div class="card">
    ...
    <div class="form-group row">
                  ...
                  <div class="col-md-6">
                          <label for="example-datetime-local-input" >سعر الباقه   </label>
                            <input class="form-control" type="number" name="price"  id="example-date-input">
                        </div>
                                    ...
                                    <div data-repeater-list="inner-group" class="inner form-group">
                                        <div data-repeater-item class="inner mb-3 row">
                                            <div class="col-md-10 col-4">
                                                <input type="text" class="inner form-control  inner-in" name="services" placeholder="أضافه أسم الخدمه   "/>
                                            </div>
            ...
            <button type="submit" class="btn btn-primary mb-2 btn-submit">@lang('translation.add_host')</button>
        </form>
