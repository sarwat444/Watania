...
@section('content')
    @component('common-components.breadcrumb')
        ...
        @slot('title') أضافه الموقف  التنفيذى @endslot
    @endcomponent
    ...
    <div class="row">
        ...
        @if(Session::has('flash_message_error'))
            ...
            <form id="create-form" action="{{url('admin/add_mawkef_tanfezy')}}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="p-4">
                                ...
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body overflow-hidden">
                                        <h5 class="font-size-16 mb-1">بيانات الموقف  التنفيذى @if($status == 0 ) 'للمالك' @else 'للياطن ' @endif </h5>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group  row">
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" type="text"  id="example-text-input" name="project_contents">
                                    ...
                                    <div  class="form-group  row">
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" type="number"  id="example-text-input" name="contract_value">
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input class="form-control" type="date"  id="example-text-input" name="contract_date">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group  row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" type="number"  id="example-text-input" name="execuation_percent">
                                        </div>
                                        <div class="col-lg-6">
                                            <label for="monsarf" >المنصرف  - باطن   </label>
                                            <input class="form-control" type="number"  id="monsarf" name="monsarf">
                                        </div>
                                    </div>
                                    <div class="form-group  row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" type="number"  id="example-text-input" name="monsarf_percent">
                                        </div>

                                        <div class="col-lg-6">
                                            <label for="estechary_office" > المكتب  الاستشاري   </label>
                                            <input class="form-control" type="text"  id="estechary_office" name="estechary_office">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea id="classic-editor" class="summernote" name="notes"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
