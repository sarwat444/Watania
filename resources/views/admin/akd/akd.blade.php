...
@component('common-components.breadcrumb')
    ...
    @slot('title') بيانات  العقد @endslot
@endcomponent
  ...
  <div class="row">
        ...
        @endif
                <div id="addproduct-accordion" class="custom-accordion">
                        <div class="card">
                            <form id="form" method="post" action="{{url('/admin/add_akd/'.$projectDetails->id)}}" enctype="multipart/form-data">
											   {{ csrf_field() }}
													...
													<div class="p-4">
														...
														<div class="media align-items-center">
															...
															<div class="media-body overflow-hidden">
																<h5 class="font-size-16 mb-1">ملفات العقد   </h5>
															</div>
                    ...
                    <button id="submit-form" onclick="submitForm()" type="submit" class="btn btn-primary mb-2 btn-submit">أظافه بيانات  العقود  </button>
