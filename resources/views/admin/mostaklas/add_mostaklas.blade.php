  ...
  <div class="row">
        ...
        @endif
                ...
                <div id="addproduct-accordion" class="custom-accordion">
                        <div class="card">
                    <form id="form" method="post" action="{{url('admin/add_mostaklas/'.$projectDetails->id)}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div id="addproduct-billinginfo-collapse" class="collapse show" data-parent="#addproduct-accordion">
                            <div class="p-4 border-top">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            <label for="date" > تاريخ الأستحقاق  </label>
                                            <input  id="date" type="date" name="date" class="form-control" placeholder="تاريخ الاستحقاق " />
                                        </div>
                                        <div class="col-md-6">
                                            <label for="value" >  القيمه الماديه   </label>
                                            <input  id="value" type="number" name="value" class="form-control" placeholder=" القيمه الماديه  "/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            <label for="value" > الموقع عليه   </label>
                                            <input id="value" type="text" name="signature_name" class="form-control" placeholder=" الموقع عليه  " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card">
                    ...
                    <button id="submit-form" onclick="submitForm()" type="submit" class="btn btn-primary mb-2 btn-submit">أظافه بيانات  المستخلص  </button>
