...
@component('common-components.breadcrumb')
    ...
    @slot('title') أضافه مستخدم جديد @endslot
@endcomponent
  ...
  <div class="row">
        ...
        @endif
            ...
            @csrf
                                ...
                                <div class="form-group  row">
                                   <div class="col-md-6">
                                       <label for="example-datetime-local-input1" >الأسم  </label>
                                        <input class="form-control" type="text"  id="example-date-input1" name="name">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="example-datetime-local-input2" > البريد الالكترونى  </label>
                                            <input class="form-control" type="text"  id="example-date-input2" name="email">
                                    </div>
                                 </div>
                                 <div class="form-group  row">
                                   <div class="col-md-6">
                                    <label for="example-datetime-local-input3" >الباسورد    </label>
                                        <input class="form-control" type="text"  id="example-date-input3" name="password" >
                                    </div>
                                    <div class="col-md-6">
                                 ...
                                 <label for="example-datetime-local-input2" >  الصلاحيات   </label>
                                         <select name="role_id" class="form-control">
                                            @if(Auth::user()->role_id == 1  )
                                             <option value="1">السوبر أدمن </option>
                                             @endif
                                             <option value="2"> الأدمن   </option>
                                             <option value="3"> wccs   </option>
                                             <option value="4"> زائر   </option>
                   ...
                   <button type="submit" class="btn btn-primary mb-2 btn-submit">أضافه بيانات  المستخدم </button>
