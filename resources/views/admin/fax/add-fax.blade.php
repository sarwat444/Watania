...
@component('common-components.breadcrumb')
    ...
    @slot('title') أضافه مكاتبه @endslot
@endcomponent
...
@endif
            ...
            <div id="addproduct-accordion" class="custom-accordion">
                <div class="card">
                    <form id="form" method="post" action="{{url('/admin/add-fax')}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group  row">
                                            <div class="col-md-6">
                                                <label for="example-text-input" >خاص بالجهه </label>
                                                    <input class="form-control" type="text" name="khas_geha"  id="example-text-input">
                                             ...
                                             <div class="col-md-6">
                                                <label for="example-text-input" > رقم القيد  </label>
                                                    <input class="form-control" type="text" name="kaed"  id="example-text-input">
                                             </div>
                                       </div>
                                       ...
                                       <div class="form-group  row">
                                            <div class="col-md-6">
                                                <label for="example-text-input" >  رقم صادر الجهه  </label>
                                                    <input class="form-control" type="text" name="sader_elgeha_number"  id="example-text-input">
                                             </div>
                                             <div class="col-md-6">
                                                <label for="example-text-input" >  تاريخ صادر الجهه </label>
                                                    <input class="form-control" type="date" name="sader_elgeha_date"  id="example-text-input">
                                             </div>
                                       </div>
                                       ...
                                       <div class="form-group  row">
                                            <div class="col-md-6">
                                                <label for="example-text-input" >    تاريخ الاصدار   </label>
                                                    <input class="form-control" type="date" name="esdar_date"  id="example-text-input">
                                             </div>
                                             <div class="col-md-6">
                                                <label for="example-text-input" >  جهه الفاكس    </label>
                                                    <input class="form-control" type="text" name="geha_fax"  id="example-text-input">
                                             </div>
